        ...
        return(
            <View style={{width:"100%", height:"100%", backgroundColor:"#EBBA2E"}}>
                ...
                <View style={styles.body}>
                    <Text style={{fontSize:20,fontWeight:"bold",margin:25}}>Sign In</Text>
                    <TextInput
                    ...
                    <TouchableOpacity style={styles.card} onPress={()=>this.props.navigation.navigate("Dashboard")}>
                        <View style={{width: "85%",backgroundColor:"white",height:"100%",borderRadius:20,justifyContent:"center"}}>
                            <Text style={{marginLeft:"10%",textAlign:"center"}}>Sign In</Text>
                        </View>
                    ...
                    <View style={{flexDirection: "row",alignSelf:"center",marginTop:"5%"}}>
                        ...
                        <Text style={{color: "#EBBA2E"}} onPress={()=>this.props.navigation.navigate("SignUp")}> Sign Up</Text>
                    </View>
                </View>
            </View>
        )
...
const styles = StyleSheet.create({
    ...
    card:{
        ...
        shadowRadius: 2,
        elevation: 10,
        width: "90%",height:"10%",backgroundColor:"#011842",alignSelf: "center",borderRadius:20,marginTop:"35%",flexDirection:"row"
    },
    Button:{
        margin: 10,
        width:"90%",
